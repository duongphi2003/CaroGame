...
settings_button = pygame.Rect(window_size[0] /2 - 200/2, 250, 200, 50)
quit_button = pygame.Rect(window_size[0] /2 - 200/2, 350, 200, 50)
...
class Game:
    ...
    def show_settings(self):
        ...
        while True:
            ...
            draw_button(off_button, 'OFF', button_font_size, DARK_GRAY, settings_screen, hover=off_button.collidepoint(mouse_pos))
